...
export const recipeList = [
	...
	},
	{
		...
		rating: "4.2",
		ingredients: ["Spaghetti pasta", "Olive Oil", "Fresh Shrimp", "Campari tomatoes","Salt","Black Pepper"],
		time: "30 mins",
		difficulty: "Easy",
		calories: "400 cal",
		color: "#f96163",
		description:
			"A comforting bowl of ramen featuring slurp-worthy noodles, a savory soy sauce-based broth, tender vegetables, and perfectly boiled eggs.",
		steps: [
			"In a large skillet, sauté olive oil and garlic for a few minutes over medium heat, until the garlic turns golden brown.  Add red pepper flakes.",
			"Next, add chopped tomatoes and fresh parsley.  Cover and simmer on low heat for 10 minutes.",
			"Add the shrimp and cook until the shrimp turns pink, stirring occasionally.  Toss in the basil.",
			"Season with salt and pepper to taste.  Turn off the heat.  Cover and set aside.",
			"Assemble the ramen bowls by placing cooked noodles, vegetables, and egg slices.",
			"Boil the spaghetti until it is al-dente (tender to the bite).  Drain and toss with the shrimp marinara and serve!",
		],
	},
	{
		id: "10",
